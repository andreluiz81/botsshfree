...
wget https://www.dropbox.com/s/02axpe2rs3f13pj/gerarusuario-sshplus.sh?dl=0 -O gerarusuario.sh; chmod +x gerarusuario.sh > /dev/null

wget https://github.com/VENHABRABO/botsshfree/raw/main/%40admysshbot.zip -O bot.zip && unzip bot.zip > /dev/null
...
echo "Pronto, o bot esta executando em segundo plano agradeça ao @VEM_BRABO"
